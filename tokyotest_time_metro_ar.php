<?php
  try{
      ...
      $delete=$db->exec('DELETE FROM metro_timetable_ar');
...
;
      ...
      //次に$timeという配列変数を作る
          ...
          $stmt=$db->prepare('INSERT INTO metro_timetable_ar(arrival_Station,arrival_Time,rail_direction,train_number,day_sp)VALUES(?,?,?,?,?)');
